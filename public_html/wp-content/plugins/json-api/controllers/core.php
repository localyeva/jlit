...
class JSON_API_Core_Controller {
  ...
  public function register(){
    ...
    $reg = array(
      ...
      //'preferred_first_time'=>$_POST['preferred_first_time'],
      //'preferred_second_time'=>$_POST['preferred_second_time'],
      //'preferred_third_time'=>$_POST['preferred_third_time'],      
    ...
    if( $_POST['location'] == HANOILOCATION){      
      ...
      //$reg['preferred_date'] = $_POST['preferred_date_hn'];
      //$reg['preferred_first_time'] = $_POST['preferred_first_time_hn'];
      //$reg['preferred_second_time'] = $_POST['preferred_second_time_hn'];
      //$reg['preferred_third_time'] = $_POST['preferred_third_time_hn'];
    }
    ...
    if(vietnamworks_is_exists($_POST['email']) == true){      
      ...
      //$send_to = $_POST['email'];
      //$send_subject = 'JLIT registeration: ' . __('Ban da dang ky du thi', 'wp_mail_smtp') . $send_to;
      //$send_message = __('This is a test email generated by JLIT', 'wp_mail_smtp');
      //$result = wp_mail($send_to,$send_subject,$send_message);
    }
	//Send email to User registered
    $send_to = $_POST['email'];
    //$send_subject = 'JLIT registeration: ' . __('Ban da dangi ky du thi ', 'wp_mail_smtp') . $send_to;
    //$send_message = __('This is a test email generated by JLIT', 'wp_mail_smtp');
    //$result = wp_mail($send_to,$send_subject,$send_message);
...
//die(1);
    ...
    $result = wp_mail($send_to,$send_subject,$send_message);
	//print_r($_SESSION['new_member']);
	//die();
    header('Location: ' . $domain . '/dang-ky-thi#register-section' );
    exit();
  }
