		...
		<div  class="container mar-t-50 bag-gray">
			...
			<div class="container content">
				...
				<div class="row mar-t-50">
					<div class="col-lg-4" data-toggle="modal" data-target="#target">
						<div class="intro-title"><a href="#"><img alt="" src="<?php bloginfo('template_url'); ?>/assets/img/vir/arrow2.png">  <?php  echo $p[1]['post_title']; ?></a></div>
						<div class="bo-intro">
