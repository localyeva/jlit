			...
			<section role="content" id="content">
				<section class="form col-md-10">
					<form role="form" class="form-horizontal" id="register" action="<?php bloginfo('siteurl') ?>?json=register" method="POST" >						
						...
						<!-- datetime hcm -->
						<div class="form-group" id="hcm">							
							<div class="form-group" id="date-hcm">
								<label for="preferred_date" class="col-md-3 control-label"><?php echo $lang['m_preferred_date']; ?></label>
								<div class="col-md-8">
									<label class="radio-inline">
										<input name="preferred_date" checked value="<?php echo PREFERRED_FIRST_DATE; ?>" type="radio"><?php echo date('d/m/Y', strtotime(PREFERRED_FIRST_DATE)); ?>
									</label>
									<label class="radio-inline">
										<input name="preferred_date"  value="<?php echo PREFERRED_SECOND_DATE; ?>" type="radio"><?php echo date('d/m/Y', strtotime(PREFERRED_SECOND_DATE)); ?>
									</label>																
								</div>
								<div class="col-md-3">
								</div>							
							</div>
							<div class="form-group" id="time-hcm">
								<label for="preferred_time" class="col-md-3 control-label"><?php echo $lang['m_preferred_time']; ?></label>							
								<div class="col-md-9">
									<label class="checkbox-inline">
										<input name="preferred_first_time"  checked value="<?php echo PREFERRED_FIRST_TIME; ?>" type="checkbox"><span class="time-val"><?php echo $lang['m_preferred_first_time'] ?></span>
									</label>
									<label class="checkbox-inline">
										<input name="preferred_second_time"  checked value="<?php echo PREFERRED_SECOND_TIME; ?>" type="checkbox"><span class="time-val"><?php echo $lang['m_preferred_second_time'] ?></span>
									</label>								
									<label class="checkbox-inline">
										<input name="preferred_third_time"  checked value="<?php echo PREFERRED_THIRD_TIME; ?>" type="checkbox"><span class="time-val"><?php echo $lang['m_preferred_third_time'] ?></span>
									</label>								
								</div>
								<div class="col-md-3">
								</div>							
						...
						<!-- datetime hn -->
						<div class="form-group" id="hn">							
							<div class="form-group" id="date-hcm">
								<label for="preferred_date_hn" class="col-md-3 control-label"><?php echo $lang['m_preferred_date']; ?></label>
								<div class="col-md-8">
									<label class="radio-inline">
										<input name="preferred_date_hn" checked value="<?php echo PREFERRED_FIRST_DATE_HN; ?>" type="radio"><?php echo date('d/m/Y', strtotime(PREFERRED_FIRST_DATE_HN)); ?>
									</label>
									<label class="radio-inline">
										<input name="preferred_date_hn"  value="<?php echo PREFERRED_SECOND_DATE_HN; ?>" type="radio"><?php echo date('d/m/Y', strtotime(PREFERRED_SECOND_DATE_HN)); ?>
									</label>																
								</div>
								<div class="col-md-3">
								</div>							
							...
							<div class="form-group" id="time-hcm">
								<label for="preferred_time" class="col-md-3 control-label"><?php echo $lang['m_preferred_time_hn']; ?></label>							
								<div class="col-md-9">
									<label class="checkbox-inline">
										<input name="preferred_first_time_hn"  checked value="<?php echo PREFERRED_FIRST_TIME_HN; ?>" type="checkbox"><span class="time-val"><?php echo $lang['m_preferred_first_time_hn'] ?></span>
									</label>
									<label class="checkbox-inline">
										<input name="preferred_second_time_hn"  checked value="<?php echo PREFERRED_SECOND_TIME_HN; ?>" type="checkbox"><span class="time-val"><?php echo $lang['m_preferred_second_time_hn'] ?></span>
									</label>								
									<label class="checkbox-inline">
										<input name="preferred_third_time_hn"  checked value="<?php echo PREFERRED_THIRD_TIME_HN; ?>" type="checkbox"><span class="time-val"><?php echo $lang['m_preferred_third_time_hn'] ?></span>
									</label>								
								</div>
								<div class="col-md-3">
								</div>							
