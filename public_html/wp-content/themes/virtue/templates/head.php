...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="http://jobs.evolable.asia/images/evaicon.png" />
  <?php if (!empty($virtue['virtue_custom_favicon']['url'])) {?>
  	...
  	<?php } ?>
  	<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/assets/css/ndcss.css" />
    <link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/assets/css/cus-virtue.css" />        
  <?php wp_head(); ?>  
